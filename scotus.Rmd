...
ggplot(scdbv3, aes(term, n_pct, color=type))+geom_line()+scale_y_continuous(labels = scales::percent, limits=c(0,NA))+ labs(titles = "Percent of Time Scalia was in the Majority", x="Term", y = "Percent of Total Decisions") + theme(legend.position="bottom")
